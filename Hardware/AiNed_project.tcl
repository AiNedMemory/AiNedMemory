...
#
# AiNed_project.tcl: Tcl script for re-creating project 'pmemory'
#
# Generated by Vivado on Thu Sep 12 20:20:08 CEST 2024
...
set script_file "AiNed_project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/pmemory"]"
...
set files [list \
 [file normalize "${origin_dir}/src/dipole.v"] \
 [file normalize "${origin_dir}/src/dpsram.v"] \
 [file normalize "${origin_dir}/src/mulshift.v"] \
 [file normalize "${origin_dir}/src/prng.v"] \
 [file normalize "${origin_dir}/src/pwrite_ctrl.v"] \
 [file normalize "${origin_dir}/src/s_axi_memory_ctrl.v"] \
 [file normalize "${origin_dir}/src/s_axi_registers.v"] \
 [file normalize "${origin_dir}/src/thirty_two64.v"] \
 [file normalize "${origin_dir}/src/AiNed_memory.v"] \
]
...
set obj [get_filesets sim_1]
set_property -name "top" -value "AiNed_memory" -objects $obj
set_property -name "top_file" -value "src/AiNed_memory.v" -objects $obj
...
# AiNed_memory
  ...
  # Create instance: AiNed_memory_0, and set properties
  set block_name AiNed_memory
  set block_cell_name AiNed_memory_0
  if { [catch {set AiNed_memory_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AiNed_memory_0 eq "" } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {238.526} \
   CONFIG.CLKOUT1_PHASE_ERROR {233.925} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {55.000} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets processing_system7_0_M_AXI_GP0] [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AiNed_memory_0/s_ctrl] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins AiNed_memory_0/s_mem] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M01_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AiNed_memory_0/s_ctrl_aclk] [get_bd_pins AiNed_memory_0/s_mem_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AiNed_memory_0/s_ctrl_aresetn] [get_bd_pins AiNed_memory_0/s_mem_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AiNed_memory_0/s_ctrl/reg0] SEG_AiNed_memory_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AiNed_memory_0/s_mem/reg0] SEG_AiNed_memory_0_reg01
...
add_files -norecurse ${origin_dir}/pmemory/pmemory.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
